    ...
    <main class="bg-gray-50">
        <div class="container mx-auto sm:px-20">
            <div class="flex justify-end my-5">
                <a
                    class="rounded-md bg-gray-600 hover:bg-gray-700 px-5 py-2.5 block text-md font-medium text-white shadow"
                        ...
                        <div class="mt-8">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="flex justify-end">
                                    <button type="submit" class="rounded-md cursor-pointer bg-indigo-600 px-7 py-2.5 text-md font-medium text-white shadow hover:bg-indigo-700">{{ __('Create') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
